        ...
        try:
            ...
            if resp.ok:
                ...
                if ipa != respText:
                    ...
                    resp = requests.get(f'https://api.west.cn/API/v2/domain/dns/?act=dnsrec.update&domain={domain}&hostname={hostname}&record_value={record_value}&apidomainkey={apidomainkey}')
                    if resp.ok:
